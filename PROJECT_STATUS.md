...
- 준비-패킷(자율): **ROS2 Humble 설치 패킷 작성 완료 (2026-07-28)** — `runbooks/nw_ros2_humble_install.md`. 랩탑 Stage04 구성 복제(ros-humble-desktop, apt `jammy main`) + AVS-007 반영(**RMW_IMPLEMENTATION 미설정 기준선** — 기본 fastrtps, 명시설정이 SIM 크래시 트리거). 프리플라이트 확인(jammy·locale·universe·curl·`/opt/ros` clean). 사용자 sudo 실행 대기.
